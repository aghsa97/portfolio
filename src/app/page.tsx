    ...
    <div className='flex flex-col gap-12 px-4 lg:px-0'>
      <div className="flex items-center justify-start">
        <div className="flex flex-col items-start justify-center gap-3">
          <h1 className="text-3xl lg:text-5xl font-bold tracking-tight text-pretty text-zinc-800">
            Programmer. Thinker. <br /> Traveller.
          </h1>
          <p className='text-zinc-950/75'>
            Hi, I&apos;m Mou Agha, I&apos;m a software engineer building serverless solutions
        ...
        <div className='flex items-center justify-center gap-6'>
          {socials.map((social, index) => (
            <a key={index} href={social.url} target={'_blank'}>
              <social.icon className="size-6 text-zinc-800 hover:-translate-y-1 transition-all duration-150 ease-in" />
            </a>
          ))}
        </div>
      </div>
